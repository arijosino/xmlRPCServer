...
/**
 * Simple XMLRPC request handler factory - this little magic class allows for a
 * request INSTANCE to be set as the handler for the xml rpc server Ideally, a
 * client shouldn't even NEED to know what this is doing.
 */
public class SimpleXmlRpcRequestHandlerFactory implements
	...
	public Object getRequestProcessor(XmlRpcRequest request)
			throws XmlRpcException {
		String handlerName = request.getMethodName().substring(0,
				request.getMethodName().lastIndexOf("."));
